...
public class BulkOperations {
    public static void main(String[] args) {
      ...
      boolean r6= group1.containsAll(Arrays.asList("Halid","Nukhet"));
        ...
        ArrayList<Character> chars = new ArrayList<>(); //blank arraylist

        chars.addAll(Arrays.asList('A','B','C','H','K'));
        System.out.println(chars);

        String[] names = {"Ali","Veli","Hasan","Veli","Emre","Sinan",};
...
//        group2.remove("Veli");
        ...
        group2.removeAll(Arrays.asList("Sinan","Emre","Veli"));
